  ...
  group('WordTokenizer', () {
    ...
    group('encode', () {
      ...
      test('should add tokens to vocabulary', () {
        ...
        expect(tokenizer.vocabulary.containsKey('hello'), isTrue);
        expect(tokenizer.vocabulary.containsKey('world'), isTrue);
      });
    });
    ...
    group('special tokens', () {
      test('should initialize with special tokens in vocabulary', () {
        expect(tokenizer.vocabulary.containsKey(WordTokenizer.unkToken), isTrue);
        expect(tokenizer.vocabulary.containsKey(WordTokenizer.padToken), isTrue);
        expect(tokenizer.vocabulary.containsKey(WordTokenizer.startToken), isTrue);
        expect(tokenizer.vocabulary.containsKey(WordTokenizer.endToken), isTrue);
      });
    });
  });
}
